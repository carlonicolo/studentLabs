...
and check the remainder - if it's zero, your number cannot be a prime; think carefully about when you should stop the process.
...
def is_prime(num):
    ...
    for i in range(2, int(num**0.5) + 1): #(elevare a potenza di 0.5 significa fare la radice quadrata )
        if num % i == 0:
            return False
